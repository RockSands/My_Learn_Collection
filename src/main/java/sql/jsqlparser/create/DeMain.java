...
public class DeMain {
	...
	public static void main(String[] args) throws JSQLParserException {
		String create = "CREATE TABLE `MyTable1` (" + "`col1`  varchar(255) NOT NULL COMMENT '注释1' ,"
				...
				+ "`col3`  varchar(255) NOT NULL DEFAULT 0 COMMENT '注释3' " + ")" + "COMMENT='我的表'" + ";";
		...
		for (ColumnDefinition index : createTable.getColumnDefinitions()) {
			...
			System.out.println("=ColumnDefinition.ColDataType=>" + index.getColDataType());
			System.out.println("=ColumnDefinition.ColDataType.DataType=>" + index.getColDataType().getDataType());
			System.out.println("=ColumnDefinition.ColDataType.ArgumentsStringList=>" + index.getColDataType().getArgumentsStringList());
			System.out.println("=ColumnDefinition.ColDataType.ArrayData=>" + index.getColDataType().getArrayData());
			//System.out.println("=ColumnDefinition.ColumnSpecStrings=>" + index.getColumnSpecStrings());
		}
		System.out.println();
